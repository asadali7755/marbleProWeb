...
import { PHONE_DISPLAY, PHONE_TEL, WA_LINK } from './constants';

export default function Fab() {
  const { open } = useRequestCall();
  return (
    <div className="fab">
      <a className="wa" href={`${WA_LINK}?text=${encodeURIComponent('Hi MarblePro, I need a quote.')}`} target="_blank" rel="noopener">
      ...
      <a className="call" href={`tel:${PHONE_TEL}`}>
      ...
      <button className="request" onClick={open}>
